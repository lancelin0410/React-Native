...
import { StyleSheet, Text, View, Image, FlatList, TouchableOpacity, Dimensions, Alert } from 'react-native';
        ...
        <View>
          <View style={styles.MainView}>
            ...
            <View style={{flex:1, marginLeft:10}}>
              <Text ellipsizeMode='tail' numberOfLines={3} style={{color:'black', fontSize:20, marginTop:3}}>
                {cases.title}
              </Text>
              <View style={{flexDirection:'row', alignItems:'center', marginTop:3, marginBottom:2, marginLeft:3}}>
                ...
                <Text ellipsizeMode='tail' numberOfLines={1} style={{color:'gray', fontSize:15, marginLeft:8}}>
                  {cases.date}
                </Text>
              </View>
            </View>
            <TouchableOpacity style={{marginRight:20, opacity:0.8}} onPress={()=>delData(cases.id)}>
